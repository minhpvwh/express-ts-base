...
const bo_user_service_1 = __importDefault(require("../../bo-users/services/bo-user.service"));
const http_middleware_1 = require("../../common/middleware/http.middleware");
class BOAuthMiddleware {
    ...
    verifyUserPassword(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield bo_user_service_1.default.getByEmail(req.body.email);
            if (user) {
...
exports.default = new BOAuthMiddleware();
